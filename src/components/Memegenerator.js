  ...
  return (
    <Wrapper>
      <form className="input-section" onSubmit={submitHandler}>
          <input type="text" name="topText" placeholder="Enter the top text" value={inputText.topText} onChange={handleChange}/>
          <input type="text" name="bottomText" placeholder="Enter the bottom text" value={inputText.bottomText} onChange={handleChange} />
          <button >
            Generate
          </button> 
      </form>
